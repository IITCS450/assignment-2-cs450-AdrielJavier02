...
main(void)
{
   ...
   e:	51                   	push   %ecx
  int pid = getpid();
   f:	e8 9f 03 00 00       	call   3b3 <getpid>
  ...
  28:	6a 01                	push   $0x1
  2a:	53                   	push   %ebx
  2b:	e8 a3 03 00 00       	call   3d3 <setpriority>
  30:	83 c4 10             	add    $0x10,%esp
  33:	85 c0                	test   %eax,%eax
  35:	74 62                	je     99 <main+0x99>
    printf(1, "FAIL: setpriority(pid,1)\n");
  37:	50                   	push   %eax
  38:	50                   	push   %eax
  39:	68 c0 07 00 00       	push   $0x7c0
  3e:	6a 01                	push   $0x1
  ...
  4b:	6a 03                	push   $0x3
  4d:	53                   	push   %ebx
  4e:	e8 80 03 00 00       	call   3d3 <setpriority>
  53:	83 c4 10             	add    $0x10,%esp
  56:	83 f8 ff             	cmp    $0xffffffff,%eax
  59:	74 51                	je     ac <main+0xac>
    printf(1, "FAIL: setpriority(pid,3) should fail\n");
  5b:	53                   	push   %ebx
  5c:	53                   	push   %ebx
  5d:	68 0c 08 00 00       	push   $0x80c
  62:	6a 01                	push   $0x1
  ...
  6f:	6a 01                	push   $0x1
  71:	68 3f 42 0f 00       	push   $0xf423f
  76:	e8 58 03 00 00       	call   3d3 <setpriority>
  7b:	83 c4 10             	add    $0x10,%esp
  7e:	83 f8 ff             	cmp    $0xffffffff,%eax
  81:	74 3c                	je     bf <main+0xbf>
    printf(1, "FAIL: setpriority(badpid,1) should fail\n");
  83:	52                   	push   %edx
  84:	52                   	push   %edx
  85:	68 54 08 00 00       	push   $0x854
  8a:	6a 01                	push   $0x1
  ...
  exit();
  94:	e8 9a 02 00 00       	call   333 <exit>
    printf(1, "OK: setpriority(pid,1)\n");
  99:	50                   	push   %eax
  9a:	50                   	push   %eax
  9b:	68 da 07 00 00       	push   $0x7da
  a0:	6a 01                	push   $0x1
  a2:	e8 e9 03 00 00       	call   490 <printf>
  a7:	83 c4 10             	add    $0x10,%esp
  aa:	eb 9c                	jmp    48 <main+0x48>
    printf(1, "OK: invalid priority rejected\n");
  ac:	51                   	push   %ecx
  ad:	51                   	push   %ecx
  ae:	68 34 08 00 00       	push   $0x834
  b3:	6a 01                	push   $0x1
  b5:	e8 d6 03 00 00       	call   490 <printf>
  ba:	83 c4 10             	add    $0x10,%esp
  bd:	eb ad                	jmp    6c <main+0x6c>
    printf(1, "OK: invalid pid rejected\n");
  bf:	50                   	push   %eax
  c0:	50                   	push   %eax
  c1:	68 f2 07 00 00       	push   $0x7f2
  c6:	6a 01                	push   $0x1
  c8:	e8 c3 03 00 00       	call   490 <printf>
  cd:	83 c4 10             	add    $0x10,%esp
  d0:	eb c2                	jmp    94 <main+0x94>
  d2:	66 90                	xchg   %ax,%ax
  d4:	66 90                	xchg   %ax,%ax
  d6:	66 90                	xchg   %ax,%ax
  d8:	66 90                	xchg   %ax,%ax
 ...
 3ec:	89 d1                	mov    %edx,%ecx
{
 ...
 419:	0f b6 92 dc 08 00 00 	movzbl 0x8dc(%edx),%edx
 ...
 499:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 509:	ff 24 85 84 08 00 00 	jmp    *0x884(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 617:	90                   	nop
          s = "(null)";
 618:	ba 7d 08 00 00       	mov    $0x87d,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 631:	a1 88 0b 00 00       	mov    0xb88,%eax
{
 ...
 671:	5b                   	pop    %ebx
  freep = p;
 672:	89 15 88 0b 00 00    	mov    %edx,0xb88
}
 678:	5e                   	pop    %esi
 679:	5f                   	pop    %edi
 67a:	5d                   	pop    %ebp
 ...
 6a9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6ac:	89 15 88 0b 00 00    	mov    %edx,0xb88
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6cc:	8b 3d 88 0b 00 00    	mov    0xb88,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 70f:	73 4f                	jae    760 <malloc+0xa0>
    ...
    if(p == freep)
 711:	8b 3d 88 0b 00 00    	mov    0xb88,%edi
 ...
 73a:	e8 f1 fe ff ff       	call   630 <free>
  return freep;
 73f:	8b 15 88 0b 00 00    	mov    0xb88,%edx
 ...
 76c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 76f:	89 15 88 0b 00 00    	mov    %edx,0xb88
}
 ...
 77f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 780:	c7 05 88 0b 00 00 8c 	movl   $0xb8c,0xb88
 787:	0b 00 00 
    base.s.size = 0;
 78a:	bf 8c 0b 00 00       	mov    $0xb8c,%edi
    base.s.ptr = freep = prevp = &base;
 78f:	c7 05 8c 0b 00 00 8c 	movl   $0xb8c,0xb8c
 796:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 799:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 79b:	c7 05 90 0b 00 00 00 	movl   $0x0,0xb90
 7a2:	00 00 00 
    if(p->s.size >= nunits){
