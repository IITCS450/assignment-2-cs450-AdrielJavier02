...
80103022:	e8 a9 29 00 00       	call   801059d0 <idtinit>
...
801030a9:	e8 32 08 00 00       	call   801038e0 <pinit>
  tvinit();        // trap vectors
801030ae:	e8 9d 28 00 00       	call   80105950 <tvinit>
  binit();         // buffer cache
...
8010382f:	89 53 1c             	mov    %edx,0x1c(%ebx)
  *(uint*)sp = (uint)trapret;
80103832:	c7 40 14 3f 59 10 80 	movl   $0x8010593f,0x14(%eax)
  p->context = (struct context*)sp;
...
801039c3:	e8 68 35 00 00       	call   80106f30 <setupkvm>
...
80103ca2:	e8 74 0c 00 00       	call   8010491b <swtch>
      switchkvm();
80103ca7:	e8 14 2e 00 00       	call   80106ac0 <switchkvm>
      c->proc = 0;
...
80103dbc:	8d 70 2c             	lea    0x2c(%eax),%esi
80103dbf:	8d 78 6c             	lea    0x6c(%eax),%edi
...
80103def:	ff 73 6c             	pushl  0x6c(%ebx)
...
80103e0a:	e8 31 08 00 00       	call   80104640 <acquire>
  wakeup1(curproc->parent);
80103e0f:	8b 53 18             	mov    0x18(%ebx),%edx
...
80103e61:	74 3b                	je     80103e9e <exit+0xfe>
    if(p->parent == curproc){
80103e63:	39 5a 18             	cmp    %ebx,0x18(%edx)
...
80103edf:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103ee5:	e8 56 06 00 00       	call   80104540 <popcli>
  acquire(&ptable.lock);
80103eea:	83 ec 0c             	sub    $0xc,%esp
80103eed:	68 20 1d 11 80       	push   $0x80111d20
80103ef2:	e8 49 07 00 00       	call   80104640 <acquire>
...
80103f11:	74 1b                	je     80103f2e <wait+0x5e>
      if(p->parent != curproc)
80103f13:	39 73 18             	cmp    %esi,0x18(%ebx)
...
80103f99:	e8 12 2f 00 00       	call   80106eb0 <freevm>
        p->pid = 0;
80103f9e:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        p->parent = 0;
80103fa5:	c7 43 18 00 00 00 00 	movl   $0x0,0x18(%ebx)
        p->name[0] = 0;
...
8010400c:	e8 2f 06 00 00       	call   80104640 <acquire>
  pushcli();
80104011:	e8 da 04 00 00       	call   801044f0 <pushcli>
  c = mycpu();
80104016:	e8 e5 f8 ff ff       	call   80103900 <mycpu>
  p = c->proc;
8010401b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104021:	e8 1a 05 00 00       	call   80104540 <popcli>
...
80104039:	e8 a2 05 00 00       	call   801045e0 <release>
}
...
8010405c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
8010405f:	e8 8c 04 00 00       	call   801044f0 <pushcli>
  c = mycpu();
80104064:	e8 97 f8 ff ff       	call   80103900 <mycpu>
  p = c->proc;
80104069:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010406f:	e8 cc 04 00 00       	call   80104540 <popcli>
  if(p == 0)
...
80104090:	e8 ab 05 00 00       	call   80104640 <acquire>
    release(lk);
80104095:	89 34 24             	mov    %esi,(%esp)
80104098:	e8 43 05 00 00       	call   801045e0 <release>
  p->chan = chan;
8010409d:	89 7b 24             	mov    %edi,0x24(%ebx)
  p->state = SLEEPING;
801040a0:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
801040a7:	e8 34 fc ff ff       	call   80103ce0 <sched>
  p->chan = 0;
801040ac:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
    release(&ptable.lock);
801040b3:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
801040ba:	e8 21 05 00 00       	call   801045e0 <release>
    acquire(lk);
...
801040cb:	5d                   	pop    %ebp
    acquire(lk);
801040cc:	e9 6f 05 00 00       	jmp    80104640 <acquire>
801040d1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  p->chan = chan;
801040d8:	89 7b 24             	mov    %edi,0x24(%ebx)
  p->state = SLEEPING;
...
8010411f:	e8 1c 05 00 00       	call   80104640 <acquire>
...
80104140:	3b 58 24             	cmp    0x24(%eax),%ebx
...
80104160:	c9                   	leave  
  release(&ptable.lock);
80104161:	e9 7a 04 00 00       	jmp    801045e0 <release>
...
8010417f:	e8 bc 04 00 00       	call   80104640 <acquire>
...
8010419f:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
      p->killed = 1;
801041a3:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
      if(p->state == SLEEPING)
...
801041bb:	e8 20 04 00 00       	call   801045e0 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
801041d8:	e8 03 04 00 00       	call   801045e0 <release>
}
...
8010424b:	ff 73 a0             	pushl  -0x60(%ebx)
...
80104275:	e8 16 02 00 00       	call   80104490 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
801042b4:	8b 75 0c             	mov    0xc(%ebp),%esi
801042b7:	53                   	push   %ebx
801042b8:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *p;

  if(prio < 0 || prio > 2)
801042bb:	83 fe 02             	cmp    $0x2,%esi
801042be:	77 74                	ja     80104334 <setpriority+0x84>
    return -1;

  acquire(&ptable.lock);
801042c0:	83 ec 0c             	sub    $0xc,%esp
801042c3:	68 20 1d 11 80       	push   $0x80111d20
801042c8:	e8 73 03 00 00       	call   80104640 <acquire>
801042cd:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801042d0:	b8 54 1d 11 80       	mov    $0x80111d54,%eax
801042d5:	eb 13                	jmp    801042ea <setpriority+0x3a>
801042d7:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801042de:	66 90                	xchg   %ax,%ax
801042e0:	83 e8 80             	sub    $0xffffff80,%eax
801042e3:	3d 54 3d 11 80       	cmp    $0x80113d54,%eax
801042e8:	74 2e                	je     80104318 <setpriority+0x68>
    if(p->state != UNUSED && p->pid == pid){
801042ea:	8b 50 0c             	mov    0xc(%eax),%edx
801042ed:	85 d2                	test   %edx,%edx
801042ef:	74 ef                	je     801042e0 <setpriority+0x30>
801042f1:	39 58 10             	cmp    %ebx,0x10(%eax)
801042f4:	75 ea                	jne    801042e0 <setpriority+0x30>
      p->priority = prio;
      release(&ptable.lock);
801042f6:	83 ec 0c             	sub    $0xc,%esp
      p->priority = prio;
801042f9:	89 70 14             	mov    %esi,0x14(%eax)
      release(&ptable.lock);
801042fc:	68 20 1d 11 80       	push   $0x80111d20
80104301:	e8 da 02 00 00       	call   801045e0 <release>
      return 0;
80104306:	83 c4 10             	add    $0x10,%esp
80104309:	31 c0                	xor    %eax,%eax
    }
  }
  release(&ptable.lock);
  return -1;
}
8010430b:	8d 65 f8             	lea    -0x8(%ebp),%esp
8010430e:	5b                   	pop    %ebx
8010430f:	5e                   	pop    %esi
80104310:	5d                   	pop    %ebp
80104311:	c3                   	ret    
...
8010431b:	68 20 1d 11 80       	push   $0x80111d20
80104320:	e8 bb 02 00 00       	call   801045e0 <release>
  return -1;
...
80104333:	c3                   	ret    
    return -1;
80104334:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104339:	eb d0                	jmp    8010430b <setpriority+0x5b>
...
801043a5:	e8 a6 fc ff ff       	call   80104050 <sleep>
  while (lk->locked) {
...
80104404:	e8 07 fd ff ff       	call   80104110 <wakeup>
  release(&lk->lk);
...
80104585:	68 ef 78 10 80       	push   $0x801078ef
8010458a:	e8 f1 bd ff ff       	call   80100380 <panic>
    panic("popcli");
8010458f:	83 ec 0c             	sub    $0xc,%esp
80104592:	68 06 79 10 80       	push   $0x80107906
...
801045fb:	68 0d 79 10 80       	push   $0x8010790d
...
801046f0:	68 15 79 10 80       	push   $0x80107915
...
80104b48:	68 1d 79 10 80       	push   $0x8010791d
...
80104ca4:	68 b8 79 10 80       	push   $0x801079b8
...
80104cbc:	68 b7 79 10 80       	push   $0x801079b7
...
80104cd1:	68 ab 79 10 80       	push   $0x801079ab
...
80104cef:	68 ba 79 10 80       	push   $0x801079ba
80104cf4:	e8 87 b6 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104cf9:	83 ec 0c             	sub    $0xc,%esp
80104cfc:	68 9c 79 10 80       	push   $0x8010799c
...
80104ded:	ff 75 f0             	pushl  -0x10(%ebp)
80104df0:	ff 75 f4             	pushl  -0xc(%ebp)
...
801050fd:	58                   	pop    %eax
801050fe:	5a                   	pop    %edx
801050ff:	68 b8 79 10 80       	push   $0x801079b8
...
80105118:	68 b7 79 10 80       	push   $0x801079b7
...
8010517d:	ff 75 b4             	pushl  -0x4c(%ebp)
...
8010519f:	ff 75 b4             	pushl  -0x4c(%ebp)
...
80105213:	ff 75 b4             	pushl  -0x4c(%ebp)
...
801052d2:	ff 75 e0             	pushl  -0x20(%ebp)
...
80105514:	e8 47 c3 ff ff       	call   80101860 <iunlock>
  iput(curproc->cwd);
80105519:	58                   	pop    %eax
8010551a:	ff 76 6c             	pushl  0x6c(%esi)
...
8010563f:	ff b5 5c ff ff ff    	pushl  -0xa4(%ebp)
...
80105916:	e8 95 e9 ff ff       	call   801042b0 <setpriority>
...
80105967:	c7 04 c5 c2 3d 11 80 	movl   $0x8e000008,-0x7feec23e(,%eax,8)
8010596e:	08 00 00 8e 
80105972:	66 89 14 c5 c0 3d 11 	mov    %dx,-0x7feec240(,%eax,8)
80105979:	80 
8010597a:	c1 ea 10             	shr    $0x10,%edx
8010597d:	66 89 14 c5 c6 3d 11 	mov    %dx,-0x7feec23a(,%eax,8)
80105984:	80 
  for(i = 0; i < 256; i++)
...
80105997:	c7 05 c2 3f 11 80 08 	movl   $0xef000008,0x80113fc2
8010599e:	00 00 ef 
  initlock(&tickslock, "time");
801059a1:	68 fd 79 10 80       	push   $0x801079fd
801059a6:	68 80 3d 11 80       	push   $0x80113d80
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801059ab:	66 a3 c0 3f 11 80    	mov    %ax,0x80113fc0
801059b1:	c1 e8 10             	shr    $0x10,%eax
801059b4:	66 a3 c6 3f 11 80    	mov    %ax,0x80113fc6
  initlock(&tickslock, "time");
...
801059db:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801059df:	b8 c0 3d 11 80       	mov    $0x80113dc0,%eax
...
80105a12:	0f 84 68 01 00 00    	je     80105b80 <trap+0x180>
    if(myproc()->killed)
      exit();
    return;
  }
...
80105a1e:	0f 87 8c 00 00 00    	ja     80105ab0 <trap+0xb0>
80105a24:	ff 24 85 a4 7a 10 80 	jmp    *-0x7fef855c(,%eax,4)
...
80105a2f:	90                   	nop
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80105a30:	e8 0b c8 ff ff       	call   80102240 <ideintr>
    lapiceoi();
80105a35:	e8 d6 ce ff ff       	call   80102910 <lapiceoi>
  }
...
80105a41:	74 1d                	je     80105a60 <trap+0x60>
80105a43:	e8 38 df ff ff       	call   80103980 <myproc>
80105a48:	8b 50 28             	mov    0x28(%eax),%edx
80105a4b:	85 d2                	test   %edx,%edx
80105a4d:	74 11                	je     80105a60 <trap+0x60>
80105a4f:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105a53:	83 e0 03             	and    $0x3,%eax
80105a56:	66 83 f8 03          	cmp    $0x3,%ax
80105a5a:	0f 84 e8 01 00 00    	je     80105c48 <trap+0x248>
    exit();
...
80105a67:	74 0f                	je     80105a78 <trap+0x78>
80105a69:	e8 12 df ff ff       	call   80103980 <myproc>
80105a6e:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80105a72:	0f 84 b8 00 00 00    	je     80105b30 <trap+0x130>
...
80105aba:	0f 84 a2 01 00 00    	je     80105c62 <trap+0x262>
80105ac0:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80105ac4:	0f 84 98 01 00 00    	je     80105c62 <trap+0x262>
...
80105ad0:	e8 8b de ff ff       	call   80103960 <cpuid>
...
80105af7:	ff 75 e4             	pushl  -0x1c(%ebp)
80105afa:	56                   	push   %esi
            myproc()->pid, myproc()->name, tf->trapno,
80105afb:	8b 75 e0             	mov    -0x20(%ebp),%esi
80105afe:	83 c6 70             	add    $0x70,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105b01:	56                   	push   %esi
80105b02:	ff 70 10             	pushl  0x10(%eax)
80105b05:	68 60 7a 10 80       	push   $0x80107a60
80105b0a:	e8 91 ab ff ff       	call   801006a0 <cprintf>
    myproc()->killed = 1;
80105b0f:	83 c4 20             	add    $0x20,%esp
80105b12:	e8 69 de ff ff       	call   80103980 <myproc>
80105b17:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b1e:	e8 5d de ff ff       	call   80103980 <myproc>
80105b23:	85 c0                	test   %eax,%eax
80105b25:	0f 85 18 ff ff ff    	jne    80105a43 <trap+0x43>
80105b2b:	e9 30 ff ff ff       	jmp    80105a60 <trap+0x60>
  if(myproc() && myproc()->state == RUNNING &&
80105b30:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
80105b34:	0f 85 3e ff ff ff    	jne    80105a78 <trap+0x78>
    yield();
80105b3a:	e8 c1 e4 ff ff       	call   80104000 <yield>
80105b3f:	e9 34 ff ff ff       	jmp    80105a78 <trap+0x78>
...
80105b57:	68 08 7a 10 80       	push   $0x80107a08
...
80105b70:	0f 85 cd fe ff ff    	jne    80105a43 <trap+0x43>
80105b76:	e9 e5 fe ff ff       	jmp    80105a60 <trap+0x60>
80105b7b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80105b7f:	90                   	nop
    if(myproc()->killed)
80105b80:	e8 fb dd ff ff       	call   80103980 <myproc>
80105b85:	8b 70 28             	mov    0x28(%eax),%esi
80105b88:	85 f6                	test   %esi,%esi
80105b8a:	0f 85 c8 00 00 00    	jne    80105c58 <trap+0x258>
    myproc()->tf = tf;
80105b90:	e8 eb dd ff ff       	call   80103980 <myproc>
80105b95:	89 58 1c             	mov    %ebx,0x1c(%eax)
    syscall();
80105b98:	e8 63 ef ff ff       	call   80104b00 <syscall>
    if(myproc()->killed)
80105b9d:	e8 de dd ff ff       	call   80103980 <myproc>
80105ba2:	8b 48 28             	mov    0x28(%eax),%ecx
80105ba5:	85 c9                	test   %ecx,%ecx
80105ba7:	0f 84 f1 fe ff ff    	je     80105a9e <trap+0x9e>
}
...
80105bb3:	5d                   	pop    %ebp
      exit();
80105bb4:	e9 e7 e1 ff ff       	jmp    80103da0 <exit>
...
80105bd1:	0f 85 6c fe ff ff    	jne    80105a43 <trap+0x43>
80105bd7:	e9 84 fe ff ff       	jmp    80105a60 <trap+0x60>
...
80105bf1:	0f 85 4c fe ff ff    	jne    80105a43 <trap+0x43>
80105bf7:	e9 64 fe ff ff       	jmp    80105a60 <trap+0x60>
80105bfc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(cpuid() == 0){
80105c00:	e8 5b dd ff ff       	call   80103960 <cpuid>
80105c05:	85 c0                	test   %eax,%eax
80105c07:	0f 85 28 fe ff ff    	jne    80105a35 <trap+0x35>
      acquire(&tickslock);
80105c0d:	83 ec 0c             	sub    $0xc,%esp
80105c10:	68 80 3d 11 80       	push   $0x80113d80
80105c15:	e8 26 ea ff ff       	call   80104640 <acquire>
      wakeup(&ticks);
80105c1a:	c7 04 24 60 3d 11 80 	movl   $0x80113d60,(%esp)
      ticks++;
80105c21:	83 05 60 3d 11 80 01 	addl   $0x1,0x80113d60
      wakeup(&ticks);
80105c28:	e8 e3 e4 ff ff       	call   80104110 <wakeup>
      release(&tickslock);
80105c2d:	c7 04 24 80 3d 11 80 	movl   $0x80113d80,(%esp)
80105c34:	e8 a7 e9 ff ff       	call   801045e0 <release>
80105c39:	83 c4 10             	add    $0x10,%esp
    lapiceoi();
80105c3c:	e9 f4 fd ff ff       	jmp    80105a35 <trap+0x35>
80105c41:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    exit();
80105c48:	e8 53 e1 ff ff       	call   80103da0 <exit>
80105c4d:	e9 0e fe ff ff       	jmp    80105a60 <trap+0x60>
80105c52:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105c58:	e8 43 e1 ff ff       	call   80103da0 <exit>
80105c5d:	e9 2e ff ff ff       	jmp    80105b90 <trap+0x190>
80105c62:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105c65:	e8 f6 dc ff ff       	call   80103960 <cpuid>
80105c6a:	83 ec 0c             	sub    $0xc,%esp
80105c6d:	56                   	push   %esi
80105c6e:	57                   	push   %edi
80105c6f:	50                   	push   %eax
80105c70:	ff 73 30             	pushl  0x30(%ebx)
80105c73:	68 2c 7a 10 80       	push   $0x80107a2c
80105c78:	e8 23 aa ff ff       	call   801006a0 <cprintf>
      panic("trap");
80105c7d:	83 c4 14             	add    $0x14,%esp
80105c80:	68 02 7a 10 80       	push   $0x80107a02
...
80105d17:	74 78                	je     80105d91 <uartinit+0xd1>
  uart = 1;
80105d19:	c7 05 c0 45 11 80 01 	movl   $0x1,0x801145c0
80105d20:	00 00 00 
...
80105d2c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105d2f:	bf 24 7b 10 80       	mov    $0x80107b24,%edi
...
80105e19:	e9 09 fb ff ff       	jmp    80105927 <alltraps>

80105e1e <vector1>:
80105e1e:	6a 00                	push   $0x0
80105e20:	6a 01                	push   $0x1
80105e22:	e9 00 fb ff ff       	jmp    80105927 <alltraps>

80105e27 <vector2>:
80105e27:	6a 00                	push   $0x0
80105e29:	6a 02                	push   $0x2
80105e2b:	e9 f7 fa ff ff       	jmp    80105927 <alltraps>

80105e30 <vector3>:
80105e30:	6a 00                	push   $0x0
80105e32:	6a 03                	push   $0x3
80105e34:	e9 ee fa ff ff       	jmp    80105927 <alltraps>

80105e39 <vector4>:
80105e39:	6a 00                	push   $0x0
80105e3b:	6a 04                	push   $0x4
80105e3d:	e9 e5 fa ff ff       	jmp    80105927 <alltraps>
...
80105e6f:	e9 b3 fa ff ff       	jmp    80105927 <alltraps>

80105e74 <vector11>:
80105e74:	6a 0b                	push   $0xb
80105e76:	e9 ac fa ff ff       	jmp    80105927 <alltraps>
...
80105e84:	e9 9e fa ff ff       	jmp    80105927 <alltraps>

80105e89 <vector14>:
80105e89:	6a 0e                	push   $0xe
80105e8b:	e9 97 fa ff ff       	jmp    80105927 <alltraps>

80105e90 <vector15>:
80105e90:	6a 00                	push   $0x0
80105e92:	6a 0f                	push   $0xf
80105e94:	e9 8e fa ff ff       	jmp    80105927 <alltraps>

80105e99 <vector16>:
80105e99:	6a 00                	push   $0x0
80105e9b:	6a 10                	push   $0x10
80105e9d:	e9 85 fa ff ff       	jmp    80105927 <alltraps>

80105ea2 <vector17>:
80105ea2:	6a 11                	push   $0x11
80105ea4:	e9 7e fa ff ff       	jmp    80105927 <alltraps>

80105ea9 <vector18>:
80105ea9:	6a 00                	push   $0x0
80105eab:	6a 12                	push   $0x12
80105ead:	e9 75 fa ff ff       	jmp    80105927 <alltraps>

80105eb2 <vector19>:
80105eb2:	6a 00                	push   $0x0
80105eb4:	6a 13                	push   $0x13
80105eb6:	e9 6c fa ff ff       	jmp    80105927 <alltraps>
...
80105eda:	e9 48 fa ff ff       	jmp    80105927 <alltraps>

80105edf <vector24>:
80105edf:	6a 00                	push   $0x0
80105ee1:	6a 18                	push   $0x18
80105ee3:	e9 3f fa ff ff       	jmp    80105927 <alltraps>

80105ee8 <vector25>:
80105ee8:	6a 00                	push   $0x0
80105eea:	6a 19                	push   $0x19
80105eec:	e9 36 fa ff ff       	jmp    80105927 <alltraps>

80105ef1 <vector26>:
80105ef1:	6a 00                	push   $0x0
80105ef3:	6a 1a                	push   $0x1a
80105ef5:	e9 2d fa ff ff       	jmp    80105927 <alltraps>

80105efa <vector27>:
80105efa:	6a 00                	push   $0x0
80105efc:	6a 1b                	push   $0x1b
80105efe:	e9 24 fa ff ff       	jmp    80105927 <alltraps>

80105f03 <vector28>:
80105f03:	6a 00                	push   $0x0
80105f05:	6a 1c                	push   $0x1c
80105f07:	e9 1b fa ff ff       	jmp    80105927 <alltraps>

80105f0c <vector29>:
80105f0c:	6a 00                	push   $0x0
80105f0e:	6a 1d                	push   $0x1d
80105f10:	e9 12 fa ff ff       	jmp    80105927 <alltraps>

80105f15 <vector30>:
80105f15:	6a 00                	push   $0x0
80105f17:	6a 1e                	push   $0x1e
80105f19:	e9 09 fa ff ff       	jmp    80105927 <alltraps>

80105f1e <vector31>:
80105f1e:	6a 00                	push   $0x0
80105f20:	6a 1f                	push   $0x1f
80105f22:	e9 00 fa ff ff       	jmp    80105927 <alltraps>

80105f27 <vector32>:
80105f27:	6a 00                	push   $0x0
80105f29:	6a 20                	push   $0x20
80105f2b:	e9 f7 f9 ff ff       	jmp    80105927 <alltraps>

80105f30 <vector33>:
80105f30:	6a 00                	push   $0x0
80105f32:	6a 21                	push   $0x21
80105f34:	e9 ee f9 ff ff       	jmp    80105927 <alltraps>

80105f39 <vector34>:
80105f39:	6a 00                	push   $0x0
80105f3b:	6a 22                	push   $0x22
80105f3d:	e9 e5 f9 ff ff       	jmp    80105927 <alltraps>

80105f42 <vector35>:
80105f42:	6a 00                	push   $0x0
80105f44:	6a 23                	push   $0x23
80105f46:	e9 dc f9 ff ff       	jmp    80105927 <alltraps>
...
80105f58:	e9 ca f9 ff ff       	jmp    80105927 <alltraps>

80105f5d <vector38>:
80105f5d:	6a 00                	push   $0x0
80105f5f:	6a 26                	push   $0x26
80105f61:	e9 c1 f9 ff ff       	jmp    80105927 <alltraps>

80105f66 <vector39>:
80105f66:	6a 00                	push   $0x0
80105f68:	6a 27                	push   $0x27
80105f6a:	e9 b8 f9 ff ff       	jmp    80105927 <alltraps>

80105f6f <vector40>:
80105f6f:	6a 00                	push   $0x0
80105f71:	6a 28                	push   $0x28
80105f73:	e9 af f9 ff ff       	jmp    80105927 <alltraps>

80105f78 <vector41>:
80105f78:	6a 00                	push   $0x0
80105f7a:	6a 29                	push   $0x29
80105f7c:	e9 a6 f9 ff ff       	jmp    80105927 <alltraps>

80105f81 <vector42>:
80105f81:	6a 00                	push   $0x0
80105f83:	6a 2a                	push   $0x2a
80105f85:	e9 9d f9 ff ff       	jmp    80105927 <alltraps>

80105f8a <vector43>:
80105f8a:	6a 00                	push   $0x0
80105f8c:	6a 2b                	push   $0x2b
80105f8e:	e9 94 f9 ff ff       	jmp    80105927 <alltraps>

80105f93 <vector44>:
80105f93:	6a 00                	push   $0x0
80105f95:	6a 2c                	push   $0x2c
80105f97:	e9 8b f9 ff ff       	jmp    80105927 <alltraps>

80105f9c <vector45>:
80105f9c:	6a 00                	push   $0x0
80105f9e:	6a 2d                	push   $0x2d
80105fa0:	e9 82 f9 ff ff       	jmp    80105927 <alltraps>

80105fa5 <vector46>:
80105fa5:	6a 00                	push   $0x0
80105fa7:	6a 2e                	push   $0x2e
80105fa9:	e9 79 f9 ff ff       	jmp    80105927 <alltraps>

80105fae <vector47>:
80105fae:	6a 00                	push   $0x0
80105fb0:	6a 2f                	push   $0x2f
80105fb2:	e9 70 f9 ff ff       	jmp    80105927 <alltraps>

80105fb7 <vector48>:
80105fb7:	6a 00                	push   $0x0
80105fb9:	6a 30                	push   $0x30
80105fbb:	e9 67 f9 ff ff       	jmp    80105927 <alltraps>

80105fc0 <vector49>:
80105fc0:	6a 00                	push   $0x0
80105fc2:	6a 31                	push   $0x31
80105fc4:	e9 5e f9 ff ff       	jmp    80105927 <alltraps>

80105fc9 <vector50>:
80105fc9:	6a 00                	push   $0x0
80105fcb:	6a 32                	push   $0x32
80105fcd:	e9 55 f9 ff ff       	jmp    80105927 <alltraps>

80105fd2 <vector51>:
80105fd2:	6a 00                	push   $0x0
80105fd4:	6a 33                	push   $0x33
80105fd6:	e9 4c f9 ff ff       	jmp    80105927 <alltraps>

80105fdb <vector52>:
80105fdb:	6a 00                	push   $0x0
80105fdd:	6a 34                	push   $0x34
80105fdf:	e9 43 f9 ff ff       	jmp    80105927 <alltraps>

80105fe4 <vector53>:
80105fe4:	6a 00                	push   $0x0
80105fe6:	6a 35                	push   $0x35
80105fe8:	e9 3a f9 ff ff       	jmp    80105927 <alltraps>

80105fed <vector54>:
80105fed:	6a 00                	push   $0x0
80105fef:	6a 36                	push   $0x36
80105ff1:	e9 31 f9 ff ff       	jmp    80105927 <alltraps>

80105ff6 <vector55>:
80105ff6:	6a 00                	push   $0x0
80105ff8:	6a 37                	push   $0x37
80105ffa:	e9 28 f9 ff ff       	jmp    80105927 <alltraps>

80105fff <vector56>:
80105fff:	6a 00                	push   $0x0
80106001:	6a 38                	push   $0x38
80106003:	e9 1f f9 ff ff       	jmp    80105927 <alltraps>

80106008 <vector57>:
80106008:	6a 00                	push   $0x0
8010600a:	6a 39                	push   $0x39
8010600c:	e9 16 f9 ff ff       	jmp    80105927 <alltraps>

80106011 <vector58>:
80106011:	6a 00                	push   $0x0
80106013:	6a 3a                	push   $0x3a
80106015:	e9 0d f9 ff ff       	jmp    80105927 <alltraps>

8010601a <vector59>:
8010601a:	6a 00                	push   $0x0
8010601c:	6a 3b                	push   $0x3b
8010601e:	e9 04 f9 ff ff       	jmp    80105927 <alltraps>

80106023 <vector60>:
80106023:	6a 00                	push   $0x0
80106025:	6a 3c                	push   $0x3c
80106027:	e9 fb f8 ff ff       	jmp    80105927 <alltraps>

8010602c <vector61>:
8010602c:	6a 00                	push   $0x0
8010602e:	6a 3d                	push   $0x3d
80106030:	e9 f2 f8 ff ff       	jmp    80105927 <alltraps>

80106035 <vector62>:
80106035:	6a 00                	push   $0x0
80106037:	6a 3e                	push   $0x3e
80106039:	e9 e9 f8 ff ff       	jmp    80105927 <alltraps>

8010603e <vector63>:
8010603e:	6a 00                	push   $0x0
80106040:	6a 3f                	push   $0x3f
80106042:	e9 e0 f8 ff ff       	jmp    80105927 <alltraps>

80106047 <vector64>:
80106047:	6a 00                	push   $0x0
80106049:	6a 40                	push   $0x40
8010604b:	e9 d7 f8 ff ff       	jmp    80105927 <alltraps>

80106050 <vector65>:
80106050:	6a 00                	push   $0x0
80106052:	6a 41                	push   $0x41
80106054:	e9 ce f8 ff ff       	jmp    80105927 <alltraps>

80106059 <vector66>:
80106059:	6a 00                	push   $0x0
8010605b:	6a 42                	push   $0x42
8010605d:	e9 c5 f8 ff ff       	jmp    80105927 <alltraps>

80106062 <vector67>:
80106062:	6a 00                	push   $0x0
80106064:	6a 43                	push   $0x43
80106066:	e9 bc f8 ff ff       	jmp    80105927 <alltraps>

8010606b <vector68>:
8010606b:	6a 00                	push   $0x0
8010606d:	6a 44                	push   $0x44
8010606f:	e9 b3 f8 ff ff       	jmp    80105927 <alltraps>

80106074 <vector69>:
80106074:	6a 00                	push   $0x0
80106076:	6a 45                	push   $0x45
80106078:	e9 aa f8 ff ff       	jmp    80105927 <alltraps>

8010607d <vector70>:
8010607d:	6a 00                	push   $0x0
8010607f:	6a 46                	push   $0x46
80106081:	e9 a1 f8 ff ff       	jmp    80105927 <alltraps>

80106086 <vector71>:
80106086:	6a 00                	push   $0x0
80106088:	6a 47                	push   $0x47
8010608a:	e9 98 f8 ff ff       	jmp    80105927 <alltraps>

8010608f <vector72>:
8010608f:	6a 00                	push   $0x0
80106091:	6a 48                	push   $0x48
80106093:	e9 8f f8 ff ff       	jmp    80105927 <alltraps>

80106098 <vector73>:
80106098:	6a 00                	push   $0x0
8010609a:	6a 49                	push   $0x49
8010609c:	e9 86 f8 ff ff       	jmp    80105927 <alltraps>

801060a1 <vector74>:
801060a1:	6a 00                	push   $0x0
801060a3:	6a 4a                	push   $0x4a
801060a5:	e9 7d f8 ff ff       	jmp    80105927 <alltraps>

801060aa <vector75>:
801060aa:	6a 00                	push   $0x0
801060ac:	6a 4b                	push   $0x4b
801060ae:	e9 74 f8 ff ff       	jmp    80105927 <alltraps>

801060b3 <vector76>:
801060b3:	6a 00                	push   $0x0
801060b5:	6a 4c                	push   $0x4c
801060b7:	e9 6b f8 ff ff       	jmp    80105927 <alltraps>

801060bc <vector77>:
801060bc:	6a 00                	push   $0x0
801060be:	6a 4d                	push   $0x4d
801060c0:	e9 62 f8 ff ff       	jmp    80105927 <alltraps>

801060c5 <vector78>:
801060c5:	6a 00                	push   $0x0
801060c7:	6a 4e                	push   $0x4e
801060c9:	e9 59 f8 ff ff       	jmp    80105927 <alltraps>

801060ce <vector79>:
801060ce:	6a 00                	push   $0x0
801060d0:	6a 4f                	push   $0x4f
801060d2:	e9 50 f8 ff ff       	jmp    80105927 <alltraps>

801060d7 <vector80>:
801060d7:	6a 00                	push   $0x0
801060d9:	6a 50                	push   $0x50
801060db:	e9 47 f8 ff ff       	jmp    80105927 <alltraps>

801060e0 <vector81>:
801060e0:	6a 00                	push   $0x0
801060e2:	6a 51                	push   $0x51
801060e4:	e9 3e f8 ff ff       	jmp    80105927 <alltraps>

801060e9 <vector82>:
801060e9:	6a 00                	push   $0x0
801060eb:	6a 52                	push   $0x52
801060ed:	e9 35 f8 ff ff       	jmp    80105927 <alltraps>

801060f2 <vector83>:
801060f2:	6a 00                	push   $0x0
801060f4:	6a 53                	push   $0x53
801060f6:	e9 2c f8 ff ff       	jmp    80105927 <alltraps>

801060fb <vector84>:
801060fb:	6a 00                	push   $0x0
801060fd:	6a 54                	push   $0x54
801060ff:	e9 23 f8 ff ff       	jmp    80105927 <alltraps>

80106104 <vector85>:
80106104:	6a 00                	push   $0x0
80106106:	6a 55                	push   $0x55
80106108:	e9 1a f8 ff ff       	jmp    80105927 <alltraps>

8010610d <vector86>:
8010610d:	6a 00                	push   $0x0
8010610f:	6a 56                	push   $0x56
80106111:	e9 11 f8 ff ff       	jmp    80105927 <alltraps>

80106116 <vector87>:
80106116:	6a 00                	push   $0x0
80106118:	6a 57                	push   $0x57
8010611a:	e9 08 f8 ff ff       	jmp    80105927 <alltraps>

8010611f <vector88>:
8010611f:	6a 00                	push   $0x0
80106121:	6a 58                	push   $0x58
80106123:	e9 ff f7 ff ff       	jmp    80105927 <alltraps>

80106128 <vector89>:
80106128:	6a 00                	push   $0x0
8010612a:	6a 59                	push   $0x59
8010612c:	e9 f6 f7 ff ff       	jmp    80105927 <alltraps>

80106131 <vector90>:
80106131:	6a 00                	push   $0x0
80106133:	6a 5a                	push   $0x5a
80106135:	e9 ed f7 ff ff       	jmp    80105927 <alltraps>

8010613a <vector91>:
8010613a:	6a 00                	push   $0x0
8010613c:	6a 5b                	push   $0x5b
8010613e:	e9 e4 f7 ff ff       	jmp    80105927 <alltraps>

80106143 <vector92>:
80106143:	6a 00                	push   $0x0
80106145:	6a 5c                	push   $0x5c
80106147:	e9 db f7 ff ff       	jmp    80105927 <alltraps>

8010614c <vector93>:
8010614c:	6a 00                	push   $0x0
8010614e:	6a 5d                	push   $0x5d
80106150:	e9 d2 f7 ff ff       	jmp    80105927 <alltraps>

80106155 <vector94>:
80106155:	6a 00                	push   $0x0
80106157:	6a 5e                	push   $0x5e
80106159:	e9 c9 f7 ff ff       	jmp    80105927 <alltraps>

8010615e <vector95>:
8010615e:	6a 00                	push   $0x0
80106160:	6a 5f                	push   $0x5f
80106162:	e9 c0 f7 ff ff       	jmp    80105927 <alltraps>

80106167 <vector96>:
80106167:	6a 00                	push   $0x0
80106169:	6a 60                	push   $0x60
8010616b:	e9 b7 f7 ff ff       	jmp    80105927 <alltraps>

80106170 <vector97>:
80106170:	6a 00                	push   $0x0
80106172:	6a 61                	push   $0x61
80106174:	e9 ae f7 ff ff       	jmp    80105927 <alltraps>

80106179 <vector98>:
80106179:	6a 00                	push   $0x0
8010617b:	6a 62                	push   $0x62
8010617d:	e9 a5 f7 ff ff       	jmp    80105927 <alltraps>

80106182 <vector99>:
80106182:	6a 00                	push   $0x0
80106184:	6a 63                	push   $0x63
80106186:	e9 9c f7 ff ff       	jmp    80105927 <alltraps>

8010618b <vector100>:
8010618b:	6a 00                	push   $0x0
8010618d:	6a 64                	push   $0x64
8010618f:	e9 93 f7 ff ff       	jmp    80105927 <alltraps>

80106194 <vector101>:
80106194:	6a 00                	push   $0x0
80106196:	6a 65                	push   $0x65
80106198:	e9 8a f7 ff ff       	jmp    80105927 <alltraps>

8010619d <vector102>:
8010619d:	6a 00                	push   $0x0
8010619f:	6a 66                	push   $0x66
801061a1:	e9 81 f7 ff ff       	jmp    80105927 <alltraps>

801061a6 <vector103>:
801061a6:	6a 00                	push   $0x0
801061a8:	6a 67                	push   $0x67
801061aa:	e9 78 f7 ff ff       	jmp    80105927 <alltraps>

801061af <vector104>:
801061af:	6a 00                	push   $0x0
801061b1:	6a 68                	push   $0x68
801061b3:	e9 6f f7 ff ff       	jmp    80105927 <alltraps>

801061b8 <vector105>:
801061b8:	6a 00                	push   $0x0
801061ba:	6a 69                	push   $0x69
801061bc:	e9 66 f7 ff ff       	jmp    80105927 <alltraps>

801061c1 <vector106>:
801061c1:	6a 00                	push   $0x0
801061c3:	6a 6a                	push   $0x6a
801061c5:	e9 5d f7 ff ff       	jmp    80105927 <alltraps>

801061ca <vector107>:
801061ca:	6a 00                	push   $0x0
801061cc:	6a 6b                	push   $0x6b
801061ce:	e9 54 f7 ff ff       	jmp    80105927 <alltraps>

801061d3 <vector108>:
801061d3:	6a 00                	push   $0x0
801061d5:	6a 6c                	push   $0x6c
801061d7:	e9 4b f7 ff ff       	jmp    80105927 <alltraps>

801061dc <vector109>:
801061dc:	6a 00                	push   $0x0
801061de:	6a 6d                	push   $0x6d
801061e0:	e9 42 f7 ff ff       	jmp    80105927 <alltraps>

801061e5 <vector110>:
801061e5:	6a 00                	push   $0x0
801061e7:	6a 6e                	push   $0x6e
801061e9:	e9 39 f7 ff ff       	jmp    80105927 <alltraps>

801061ee <vector111>:
801061ee:	6a 00                	push   $0x0
801061f0:	6a 6f                	push   $0x6f
801061f2:	e9 30 f7 ff ff       	jmp    80105927 <alltraps>

801061f7 <vector112>:
801061f7:	6a 00                	push   $0x0
801061f9:	6a 70                	push   $0x70
801061fb:	e9 27 f7 ff ff       	jmp    80105927 <alltraps>

80106200 <vector113>:
80106200:	6a 00                	push   $0x0
80106202:	6a 71                	push   $0x71
80106204:	e9 1e f7 ff ff       	jmp    80105927 <alltraps>

80106209 <vector114>:
80106209:	6a 00                	push   $0x0
8010620b:	6a 72                	push   $0x72
8010620d:	e9 15 f7 ff ff       	jmp    80105927 <alltraps>

80106212 <vector115>:
80106212:	6a 00                	push   $0x0
80106214:	6a 73                	push   $0x73
80106216:	e9 0c f7 ff ff       	jmp    80105927 <alltraps>

8010621b <vector116>:
8010621b:	6a 00                	push   $0x0
8010621d:	6a 74                	push   $0x74
8010621f:	e9 03 f7 ff ff       	jmp    80105927 <alltraps>

80106224 <vector117>:
80106224:	6a 00                	push   $0x0
80106226:	6a 75                	push   $0x75
80106228:	e9 fa f6 ff ff       	jmp    80105927 <alltraps>

8010622d <vector118>:
8010622d:	6a 00                	push   $0x0
8010622f:	6a 76                	push   $0x76
80106231:	e9 f1 f6 ff ff       	jmp    80105927 <alltraps>

80106236 <vector119>:
80106236:	6a 00                	push   $0x0
80106238:	6a 77                	push   $0x77
8010623a:	e9 e8 f6 ff ff       	jmp    80105927 <alltraps>

8010623f <vector120>:
8010623f:	6a 00                	push   $0x0
80106241:	6a 78                	push   $0x78
80106243:	e9 df f6 ff ff       	jmp    80105927 <alltraps>

80106248 <vector121>:
80106248:	6a 00                	push   $0x0
8010624a:	6a 79                	push   $0x79
8010624c:	e9 d6 f6 ff ff       	jmp    80105927 <alltraps>

80106251 <vector122>:
80106251:	6a 00                	push   $0x0
80106253:	6a 7a                	push   $0x7a
80106255:	e9 cd f6 ff ff       	jmp    80105927 <alltraps>
...
80106267:	e9 bb f6 ff ff       	jmp    80105927 <alltraps>

8010626c <vector125>:
8010626c:	6a 00                	push   $0x0
8010626e:	6a 7d                	push   $0x7d
80106270:	e9 b2 f6 ff ff       	jmp    80105927 <alltraps>

80106275 <vector126>:
80106275:	6a 00                	push   $0x0
80106277:	6a 7e                	push   $0x7e
80106279:	e9 a9 f6 ff ff       	jmp    80105927 <alltraps>
...
8010685e:	e9 c4 f0 ff ff       	jmp    80105927 <alltraps>

80106863 <vector253>:
80106863:	6a 00                	push   $0x0
80106865:	68 fd 00 00 00       	push   $0xfd
8010686a:	e9 b8 f0 ff ff       	jmp    80105927 <alltraps>

8010686f <vector254>:
8010686f:	6a 00                	push   $0x0
80106871:	68 fe 00 00 00       	push   $0xfe
80106876:	e9 ac f0 ff ff       	jmp    80105927 <alltraps>

8010687b <vector255>:
8010687b:	6a 00                	push   $0x0
8010687d:	68 ff 00 00 00       	push   $0xff
80106882:	e9 a0 f0 ff ff       	jmp    80105927 <alltraps>
...
8010692f:	68 e6 74 10 80       	push   $0x801074e6
...
801069d5:	e8 26 dd ff ff       	call   80104700 <memset>
...
80106a1d:	68 2c 7b 10 80       	push   $0x80107b2c
...
80106ac0:	a1 c4 45 11 80       	mov    0x801145c4,%eax
...
80106af4:	0f 84 c2 00 00 00    	je     80106bbc <switchuvm+0xec>
  pushcli();
80106afa:	e8 f1 d9 ff ff       	call   801044f0 <pushcli>
...
80106c0f:	e8 ec da ff ff       	call   80104700 <memset>
...
80106c42:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106c43:	e9 58 db ff ff       	jmp    801047a0 <memmove>
    panic("inituvm: more than a page");
80106c48:	83 ec 0c             	sub    $0xc,%esp
80106c4b:	68 71 7b 10 80       	push   $0x80107b71
...
80106cb0:	68 8b 7b 10 80       	push   $0x80107b8b
...
80106cfb:	ff 75 10             	pushl  0x10(%ebp)
...
80106d38:	68 2c 7c 10 80       	push   $0x80107c2c
...
80106e3b:	68 c1 7b 10 80       	push   $0x80107bc1
...
80106f1c:	68 dd 7b 10 80       	push   $0x80107bdd
...
80106f61:	ff 73 0c             	pushl  0xc(%ebx)
...
80106fbb:	a3 c4 45 11 80       	mov    %eax,0x801145c4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106fec:	68 ee 7b 10 80       	push   $0x80107bee
...
80107062:	68 f8 7b 10 80       	push   $0x80107bf8
...
80107117:	ff 75 e0             	pushl  -0x20(%ebp)
...
80107137:	68 12 7c 10 80       	push   $0x80107c12
...
801071f0:	e8 ab d5 ff ff       	call   801047a0 <memmove>
    len -= n;
    buf += n;
